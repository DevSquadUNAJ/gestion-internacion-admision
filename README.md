...
Por defecto, todo el código interno (carpetas, namespaces y el .sln) se llama `Admision`. Para cambiar todo esto de forma segura y automática, abre **PowerShell** dentro de la carpeta de tu nuevo repositorio y pega el siguiente script.
